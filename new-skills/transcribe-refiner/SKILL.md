...
**Audience:** Users processing raw auto-generated captions into clean transcripts.
**Goal:** Transform raw captions into coherent, readable transcripts with zero substantive content loss.
...
- Normalize names (e.g., rewrite `[rishabh]` as `**Rishabh:**`)
...
1. **transcribe-refiner** (this) -- produces clean transcript + Topic Inventory
2. **lecture-alchemist** -- produces structured study notes (verifies against inventory)
3. **concept-cartographer** -- produces visual diagrams (verifies against inventory)
