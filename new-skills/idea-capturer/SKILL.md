...
- **Question:** What makes this interesting? What's unclear?
- **Connect:** How does this relate to other ideas or knowledge?
- **Research:** What do you need to learn to develop this?
...
- **Connect:** Link ideas that inform each other
- **Prioritize:** What deserves development time?
...
- **Divergent Phase:** Generate without judgment (quantity over quality)
- **Clustering:** Group similar ideas
- **Convergent Phase:** Identify most promising
- **Development:** Take top ideas deeper
...
- **Cross-Pollination:** How do disparate ideas connect?
- **Conflict Resolution:** Where do ideas contradict?
- **Novel Combinations:** What new insights emerge?
- **Expression:** Write, sketch, or prototype the synthesis
...
1. **Why?** Because I'm frustrated with current tools
2. **Why?** They're too complex for simple needs
3. **Why?** They try to do everything
4. **Why?** They're designed for teams, not individuals
5. **Why?** Market incentives favor enterprise sales
...
If yes, capture now and judge later.
...
- **Just archive:** Interesting but not pursuing
